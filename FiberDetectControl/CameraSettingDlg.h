...
public:
	...
	afx_msg void OnBnClickedButtonStartGrabB();
	afx_msg void OnBnClickedButtonStartGrabC();
	afx_msg void OnBnClickedButtonStartGrabD();
	afx_msg void OnBnClickedButtonStopGrabB();
	afx_msg void OnBnClickedButtonStopGrabC();
	afx_msg void OnBnClickedButtonStopGrabD();
