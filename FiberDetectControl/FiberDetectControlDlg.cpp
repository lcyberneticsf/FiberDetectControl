...
LRESULT CFiberDetectControlDlg::UpdateImg(WPARAM wParam, LPARAM lParam)
{
	...
	if (nCtrlSignalling == 20)
	{
		...
		if (m_bSaveImage)
		{
			...
			std::string tarin_img_path=file_path+std::to_string(m_nImageCounter) + ".bmp";
		...
		if (m_bSaveDetectResultLabel)
		{
			...
			{
				m_nImageCounter++;
				//std::string m_path_label = "f:/save_image/m_images/label/";
				std::string m_path_label = m_strSaveDetectResultPath + "/m_images/";
				_mkdir(m_path_label.c_str());
				m_path_label = m_strSaveDetectResultPath + "/m_images/label/";
				std::string m_path_source = m_strSaveDetectResultPath + "/m_images/source/";
				_mkdir(m_path_label.c_str());
...
void CFiberDetectControlDlg::ShowCameraCtrl(void *pParam)
{
