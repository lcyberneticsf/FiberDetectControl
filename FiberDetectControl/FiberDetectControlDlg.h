...
public:
	...
	afx_msg LRESULT Setwindow(WPARAM wParam, LPARAM lParam);
public:
	...
	int m_labelACounter = 0;
	int m_labelBCounter = 0;
	int m_labelCCounter = 0;
	int m_labelDCounter = 0;

	int m_imageACounter = 0;
	int m_imageBCounter = 0;
	int m_imageCCounter = 0;
	int m_imageDCounter = 0;

	bool m_bSaveImage = false;
	bool m_bSaveDetectResultLabel = false;
	int m_nSaveDetectResultLabelCamera = 1;
	int m_nSaveTrainImageCamera = 1;
