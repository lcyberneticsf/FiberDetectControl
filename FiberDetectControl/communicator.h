...
public:
	...
	asio::io_service* io_service_1;
	asio::io_service* img_io_service_1;
	//asio::ip::basic_endpoint<asio::ip::tcp>* ep_;
	tcp::endpoint  * ep_1;
	tcp::endpoint  * img_ep_1;
	asio::basic_stream_socket<asio::ip::tcp>* socket_1;
	asio::basic_stream_socket<asio::ip::tcp>* img_socket_1;
	std::string data_buffer_1;
	asio::ip::tcp::socket* _socket1;
	...
	static bool m_bMagneticValveShow;
};
