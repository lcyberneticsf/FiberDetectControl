...
BEGIN_MESSAGE_MAP(CNetSetting, CDialogEx)
	...
	ON_BN_CLICKED(IDC_BUTTON_OPEN_CAMERA_A, &CNetSetting::OnBnClickedButtonOpenCameraA)
	ON_BN_CLICKED(IDC_BUTTON_STOP_CAMERA_A, &CNetSetting::OnBnClickedButtonStopCameraA)
	ON_BN_CLICKED(IDC_BUTTON_OPEN_CAMERA_B, &CNetSetting::OnBnClickedButtonOpenCameraB)
	ON_BN_CLICKED(IDC_BUTTON_OPEN_CAMERA_C, &CNetSetting::OnBnClickedButtonOpenCameraC)
	ON_BN_CLICKED(IDC_BUTTON_OPEN_CAMERA_D, &CNetSetting::OnBnClickedButtonOpenCameraD)
	ON_BN_CLICKED(IDC_BUTTON_STOP_CAMERA_B, &CNetSetting::OnBnClickedButtonStopCameraB)
	ON_BN_CLICKED(IDC_BUTTON_STOP_CAMERA_C, &CNetSetting::OnBnClickedButtonStopCameraC)
	ON_BN_CLICKED(IDC_BUTTON_STOP_CAMERA_D, &CNetSetting::OnBnClickedButtonStopCameraD)
	ON_BN_CLICKED(IDC_BUTTON_CAMERA4_NET, &CNetSetting::OnBnClickedButtonCamera4Net)
	ON_BN_CLICKED(IDC_BUTTON_START_GRAB_A, &CNetSetting::OnBnClickedButtonStartGrabA)
	ON_BN_CLICKED(IDC_BUTTON_STOP_GRAB_A, &CNetSetting::OnBnClickedButtonStopGrabA)
END_MESSAGE_MAP()
...
Author :LF
date: 2020-11-21
Function name:  OnBnClickedButtonCamera2Net()
Function:
1) Send camera C parameters to AI-BOX;
2) Update the camera C device parameters and save an local ini file;
*/
...
void CNetSetting::OnBnClickedButtonCamera3Net()
{
	...
	parameters_setting_trans.signalling = 5;
	memcpy(&frame->parameters_setting_trans, &parameters_setting_trans, sizeof(parameters_setting_trans));
	frame->magnetic_valve_num = 3;     //The camera C serial number is 3; 
	frame->signalling = 5;
	::PostMessage(AfxGetMainWnd()->m_hWnd, ID_SHOWCTRLMESSAGE, frame->signalling, (LPARAM)frame);
}
...
Function name:  OnBnClickedButtonCamera2Net()
Function:
		1) Send camera B parameters to AI-BOX;
		2) Update the camera B device parameters and save an local ini file;
*/
...
void CNetSetting::OnBnClickedButtonElectricalLocalNetSetting()
{
	...
	CString IniWrite;
	IniWrite.Format("%s", local_ip.c_str());
...
void CNetSetting::OnBnClickedButtonElectricalDriverNetSetting()
{
	...
	CString IniWrite;
	IniWrite.Format("%s", electric_board_ip.c_str());
...
void CNetSetting::OnBnClickedButtonComputer2NetSetting()
{
	...
	CString IniWrite;
	IniWrite.Format("%s", box2_ip.c_str());
...
void CNetSetting::OnBnClickedButtonComputer1NetSetting()
{
	...
	CString IniWrite;
	IniWrite.Format("%s", box1_ip.c_str());
...
void CNetSetting::OnBnClickedOk()
{
	...
	ReadIni();
	Vsee::VCameraMessageTrans *frame = new Vsee::VCameraMessageTrans;
	parameters_setting_trans.signalling = 30;
	memcpy(&frame->parameters_setting_trans, &parameters_setting_trans, sizeof(parameters_setting_trans));
	frame->signalling = 4;
	::PostMessage(AfxGetMainWnd()->m_hWnd, ID_SHOWCTRLMESSAGE, frame->signalling, (LPARAM)frame);
	CDialogEx::OnOK();
...
void CNetSetting::OnBnClickedButtonOpenCameraA()
{
	// TODO:  在此添加控件通知处理程序代码
	Vsee::VCameraMessageTrans *frame = new Vsee::VCameraMessageTrans;
...
void CNetSetting::OnBnClickedButtonStopCameraA()
{
	// TODO:  在此添加控件通知处理程序代码
	Vsee::VCameraMessageTrans *frame = new Vsee::VCameraMessageTrans;
...
void CNetSetting::OnBnClickedButtonOpenCameraB()
{
	// TODO:  在此添加控件通知处理程序代码
	Vsee::VCameraMessageTrans *frame = new Vsee::VCameraMessageTrans;
	parameters_setting_trans.signalling = 11;
...
void CNetSetting::OnBnClickedButtonOpenCameraC()
{
	// TODO:  在此添加控件通知处理程序代码
	Vsee::VCameraMessageTrans *frame = new Vsee::VCameraMessageTrans;
	parameters_setting_trans.signalling = 11;
...
void CNetSetting::OnBnClickedButtonOpenCameraD()
{
	// TODO:  在此添加控件通知处理程序代码
	Vsee::VCameraMessageTrans *frame = new Vsee::VCameraMessageTrans;
	parameters_setting_trans.signalling = 11;
...
void CNetSetting::OnBnClickedButtonStopCameraB()
{
	// TODO:  在此添加控件通知处理程序代码
	Vsee::VCameraMessageTrans *frame = new Vsee::VCameraMessageTrans;
	parameters_setting_trans.signalling = 12;
	memcpy(&frame->parameters_setting_trans, &parameters_setting_trans, sizeof(parameters_setting_trans));
	frame->signalling = 12;
	frame->magnetic_valve_num = 2;  //To indicate camera B serial number is 2;
	::PostMessage(AfxGetMainWnd()->m_hWnd, ID_SHOWCTRLMESSAGE, frame->signalling, (LPARAM)frame);
}


void CNetSetting::OnBnClickedButtonStopCameraC()
{
	// TODO:  在此添加控件通知处理程序代码
	Vsee::VCameraMessageTrans *frame = new Vsee::VCameraMessageTrans;
	parameters_setting_trans.signalling = 12;
	memcpy(&frame->parameters_setting_trans, &parameters_setting_trans, sizeof(parameters_setting_trans));
	frame->signalling = 12;
	frame->magnetic_valve_num = 3;  //To indicate camera C serial number is 3;
	::PostMessage(AfxGetMainWnd()->m_hWnd, ID_SHOWCTRLMESSAGE, frame->signalling, (LPARAM)frame);
}


void CNetSetting::OnBnClickedButtonStopCameraD()
{
	// TODO:  在此添加控件通知处理程序代码
	Vsee::VCameraMessageTrans *frame = new Vsee::VCameraMessageTrans;
	parameters_setting_trans.signalling = 12;
	memcpy(&frame->parameters_setting_trans, &parameters_setting_trans, sizeof(parameters_setting_trans));
	frame->signalling = 12;
	frame->magnetic_valve_num = 4;  //To indicate camera D serial number is 4;
	::PostMessage(AfxGetMainWnd()->m_hWnd, ID_SHOWCTRLMESSAGE, frame->signalling, (LPARAM)frame);
}


void CNetSetting::OnBnClickedButtonCamera4Net()
{
	// TODO:  在此添加控件通知处理程序代码
	int camera_total;
	char IniRead[255];
...
void CNetSetting::OnBnClickedButtonStartGrabA()
{
	// TODO:  在此添加控件通知处理程序代码
	Vsee::VCameraMessageTrans *frame = new Vsee::VCameraMessageTrans;
...
void CNetSetting::OnBnClickedButtonStopGrabA()
{
	// TODO:  在此添加控件通知处理程序代码
	Vsee::VCameraMessageTrans *frame = new Vsee::VCameraMessageTrans;
